...
import {ERC721ValueProviderETH} from './ERC721ValueProviderETH.sol';
    ...
    ReentrancyGuardUpgradeable
{
    ...
    /// @param _nftIndex The NFT to check
    /// @return The TriUSD debt interest accumulated by the NFT at index `_nftIndex`.
    ...
    function _getCreditLimit(
        ...
        return valueProvider.getCreditLimitETH(_owner, _nftIndex);
    }
    ...
    function _getLiquidationLimit(
        ...
        return valueProvider.getLiquidationLimitETH(_owner, _nftIndex);
    }
