...
abstract contract ERC1155ValueProviderBTC is
    ...
    AccessControlUpgradeable
{
    ...
    uint256 public overriddenFloorValueBTC;
    ...
    function getCreditLimitBTC(
        ...
        return _creditLimitRate.calculate(getNFTValueBTC(_colAmount));
    }
    ...
    function getLiquidationLimitBTC(
        ...
        return _liquidationLimitRate.calculate(getNFTValueBTC(_colAmount));
    }

    /// @return The floor value for the collection, in BTC.
    function getFloorBTC() public view virtual returns (uint256) {
        if (daoFloorOverride) {
            return overriddenFloorValueBTC;
        }
    ...
    /// @param _colAmount The collateral amount
    /// @return The value in BTC of the NFT at index `_nftIndex`, with 18 decimals.
    function getNFTValueBTC(uint256 _colAmount) public view returns (uint256) {
        uint256 _floor = getFloorBTC();
    ...
    function overrideFloor(
        ...
        overriddenFloorValueBTC = _newFloor;
