...
contract Obelisk is ERC1155PausableUpgradeable, OwnableUpgradeable {
    ...
    /// @dev BASE URI
    string private constant BASE_URI = 'https://metadata.trireme.io/obelisk/';

    /// @notice name
    string public constant name = 'Trireme Obelisk';
    ...
    function mint(ObeliskType obeliskType) external payable {
        ...
        require(success);
        IERC20MintableBurnable(addressProvider.getTrireme()).burnFrom(
            account,
            info.triremeAmount
        );
